...
SFTP\_PORT (Default 2222)

SFTP\_HOST\_KEY\_PATH (Default -> use a generated key - currently only works with RSA keys)

SFTP\_HOST\_KEY\_PW (Default -> no passwordcheck)
